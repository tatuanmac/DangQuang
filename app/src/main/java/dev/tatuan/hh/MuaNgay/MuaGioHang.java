...
public class MuaGioHang extends AppCompatActivity {
    RecyclerView rcItem;
    ...
    private void getData() {
        databaseReference.child("giohang").child(phone).addValueEventListener(new ValueEventListener() {
            @Override
            ...
            public void onClick(View v) {
                ...
                db.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        databaseReference = FirebaseDatabase.getInstance().getReference("giohang").child(phone);
